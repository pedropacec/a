...
(function () {
  ...
  /* Wordmark oficial (assets/img/vesse-wordmark.svg): duas metades do
     ...
     header é SOMENTE "Vèsse Club" (direção do Pedro, 01/08): o © do
     vetor foi cortado das duas rotas de exibição.                     */
  var LOCK_TOP =
    '<svg class="half t" id="lockT" viewBox="0 -2 1000 325" fill="currentColor" aria-hidden="true" focusable="false">' +
